...
y_train, y_test, x_train, x_test = train_test_split(y, x, test_size = 0.15) #can add random_state = int to shuffle the data #can add random_state = int to shuffle the data
